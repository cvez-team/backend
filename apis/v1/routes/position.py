...
async def update_position(project_id: str, position_id: int, data: UpdatePositionInterface, user: Annotated[UserSchema, Depends(get_current_user)]):
...
async def close_position(project_id: str, position_id: int, user: Annotated[UserSchema, Depends(get_current_user)]):
...
async def open_position(project_id: str, position_id: int, user: Annotated[UserSchema, Depends(get_current_user)]):
...
async def delete_position(project_id: str, position_id: int, user: Annotated[UserSchema, Depends(get_current_user)]):
